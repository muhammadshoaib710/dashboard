...
function Main() {
  return (
    <section className="w-2/5  grow bg-white h-screen overflow-y-auto flex flex-col justify-start items-center gap-2 p-4">
      <Header />
      <div
        id="main-section"
      ...
      >
        ...
        >
          <div className="grid lg-grid-cols-3 grid-cols-1 gap-4 w-full mb-4">
            <div className="w-1/4 flex flex-col justify-center items-center bg-blue-200 p-5 rounded-xl gap-5 transition-transform transform hover:rotate-[-5deg] hover:rotate[-5deg] cursor-pointer">
